...
setupparams ( void ) 
{
  ...
  kpsesetprogramname ( argv [0 ], "bibtex" ) ;
...
#define noptions ( 4 ) 
  ...
  do {
    ...
    {
      printversionandexit ( "This is BibTeX, Version 0.99d" , "Oren Patashnik" 
      , nil , nil ) ;
    } 
...
void mainbody( void ) {
  ...
  {
    {
      Fputs ( logfile ,  "This is BibTeX, Version 0.99d" ) ;
      Fputs ( standardoutput ,  "This is BibTeX, Version 0.99d" ) ;
    } 
    {
      fprintf ( logfile , "%s\n",  versionstring ) ;
      fprintf ( standardoutput , "%s\n",  versionstring ) ;
